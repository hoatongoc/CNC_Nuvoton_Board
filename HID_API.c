...
void HID_SetOutReport(uint8_t *pu8EpBuf)
{
	...
	//indexes:
	// 0 : command index (no idea what the hell it is)
	// 1 : size of buffer
	// 2 : high part of output value that nuvoton receive
	// 3 : low part of output value that nuvoton receive
	// 4 : decide what func will execute
