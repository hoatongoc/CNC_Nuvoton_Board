#line 1 "Src\\Driver\\DrvUSB.c"
 
 
 
 
 
#line 1 ".\\Include\\Driver\\DrvUSB.h"
...
#line 1 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 1 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 56 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 82 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 377 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 395 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 500 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 770 ".\\Include\\CoreSupport\\core_cm0.h"
...
#line 75 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
#line 1 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\system_NUC1xx.h"
...
#line 76 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 77 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6629 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6685 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6703 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6756 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6782 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"

#line 6789 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6835 ".\\Include\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"


                                                                                                 
#line 10 ".\\Include\\Driver\\DrvUSB.h"
...
#line 73 ".\\Include\\Driver\\DrvUSB.h"

#line 80 ".\\Include\\Driver\\DrvUSB.h"

#line 92 ".\\Include\\Driver\\DrvUSB.h"

#line 103 ".\\Include\\Driver\\DrvUSB.h"

#line 111 ".\\Include\\Driver\\DrvUSB.h"




#line 122 ".\\Include\\Driver\\DrvUSB.h"





#line 137 ".\\Include\\Driver\\DrvUSB.h"
...
#line 241 ".\\Include\\Driver\\DrvUSB.h"


 
 
 
#line 253 ".\\Include\\Driver\\DrvUSB.h"
...
#line 284 ".\\Include\\Driver\\DrvUSB.h"

#line 291 ".\\Include\\Driver\\DrvUSB.h"
...
int32_t DrvUSB_Open(void * pVoid)
{
    ...
    p = (uint8_t *)(((( uint32_t)0x40000000) + 0x60000) + 0x100);
    
     
    gsUsbDevice.sEpCrl[6].u32EpNum = 0x0;
    gsUsbDevice.sEpCrl[6].u32MaxPacketSize = 8;
    gsUsbDevice.sEpCrl[6].u8SramBuffer = p;
    p += 8;
    ...
    {       
        ...
        if (sEpDescription[i].u8SramBuffer == 0)
        {               
            if (j < i)
            {
        ...
        if ((sEpDescription[i].u32EpNum & 0x1f) == 0)
        {
            ...
            CFG_EP_SETTING[i] = (0x00000200 | 
              ((sEpDescription[i].u32EpNum&0x80)?0x00000040:0x00000020) 
              | (sEpDescription[i].u32EpNum&0x0F));
        }
        else
        {
            CFG_EP_SETTING[i] = ((sEpDescription[i].u32EpNum&0x80)?0x00000040:0x00000020) 
              | (sEpDescription[i].u32EpNum&0x0F);
        }
    ...
    gsUsbDevice.u32FLDET = ((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->FLDET.FLDET;
    DrvUSB_PreDispatchFDTEvent(&gsUsbDevice);
    DrvUSB_DispatchMiscEvent(&gsUsbDevice);
    
    NVIC_SetPriority (USBD_IRQn, (1<<2) - 2);
...
void DrvUSB_PreDispatchEvent(void)
{
    gsUsbDevice.u32INTSTS = (*((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS))));

    if (gsUsbDevice.u32INTSTS & 0x00000008)
    {
         
        *((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS)))=(0x00000008);
        
         
        DrvUSB_PreDispatchWakeupEvent(&gsUsbDevice);
    }
    else if (gsUsbDevice.u32INTSTS & 0x00000004)
    {
        gsUsbDevice.u32FLDET = ((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->FLDET.FLDET;
    ...
    else if (gsUsbDevice.u32INTSTS & 0x00000001)
    {
        gsUsbDevice.u32ATTR = *((volatile uint32_t *)(&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR));
    ...
    else if (gsUsbDevice.u32INTSTS & 0x00000002)
    {
        gsUsbDevice.u32EPSTS = (*((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->EPSTS))));
...
int32_t DrvUSB_GetEpIdentity(uint32_t u32EpNum, uint32_t u32EpAttr)
{
    ...
    return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVUSB) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((2) & 0x7F));
...
int32_t DrvUSB_DataOutTrigger(uint32_t u32EpNum, uint32_t u32Size)
{
    ...
    u32EpId = DrvUSB_GetEpIdentity(u32EpNum, 0x00);
    
    if (u32Size > psDevice->sEpCrl[u32EpId].u32MaxPacketSize)
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVUSB) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((3) & 0x7F));

        
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x20)+(0x10 * (u32EpId))))=((uint32_t)psDevice ->sEpCrl[u32EpId]. u8SramBuffer) - (((( uint32_t)0x40000000) + 0x60000) + 0x100);
    *((volatile unsigned int *)(((((( uint32_t)0x40000000) + 0x60000) + 0x24)+(0x10*(u32EpId)))))=(u32Size);
...
uint8_t * DrvUSB_GetOutData(uint32_t u32EpNum, uint32_t *u32Size)
{
    ...
    u32EpId = DrvUSB_GetEpIdentity(u32EpNum, 0x00);
    *u32Size = (*((volatile unsigned short *)((((( uint32_t)0x40000000) + 0x60000) + 0x24) + (0x10*(u32EpId)))));
...
int32_t DrvUSB_DataIn(uint32_t u32EpNum, const uint8_t * u8Buffer, uint32_t u32Size)
{
    ...
    u32EpId = DrvUSB_GetEpIdentity(u32EpNum, 0x80);
    ...
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x20)+(0x10 * (u32EpId))))=((uint32_t)psDevice ->sEpCrl[u32EpId]. u8SramBuffer) - (((( uint32_t)0x40000000) + 0x60000) + 0x100);
    ...
    if (u8Buffer == 0 && u32Size == 0)
        psDevice->abData0[u32EpId] = 0;
    else
        psDevice->abData0[u32EpId] = !psDevice->abData0[u32EpId];
    
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId))))=psDevice ->abData0[u32EpId] ? (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId)))))) & 0x37F) : (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId)))))) | 0x80);
    *((volatile unsigned int *)(((((( uint32_t)0x40000000) + 0x60000) + 0x24)+(0x10*(u32EpId)))))=(u32Size);
...
void DrvUSB_BusResetCallback(void * pVoid)
{
    ...
    ((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTEN.INNAK_EN = 0;

    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x18)))=(DrvUSB_GetSetupBuffer()) - (((( uint32_t)0x40000000) + 0x60000) + 0x100);
    ...
    while (sEpDescription[i].u32MaxPacketSize != 0)
    {
        ...
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10 * (i))))=(0x01) & 0x03;
        
         
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(i))))=(CFG_EP_SETTING[i]) & 0x03FF;
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x20)+(0x10 * (i))))=((uint32_t)sEpDescription[i]. u8SramBuffer) - (((( uint32_t)0x40000000) + 0x60000) + 0x100);
        i++;
    }
                ...
                S_DRVUSB_CTRL_CALLBACK_ENTRY *psCtrlCallbackEntry,uint32_t u32RegCnt)
{
    ...
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVUSB) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
    }
    ...
    for (i = 0; i < u32RegCnt; i++)
    {
        ...
        if (psEntry->pfnCtrlDataInCallback == 0)
            psEntry->pfnCtrlDataInCallback = DrvUSB_CtrlDataInDefault;
        if (psEntry->pfnCtrlDataOutCallback == 0)
...
void DrvUSB_CtrlDataInDefault(void * pVoid)
{
    ...
    {
        *((volatile unsigned int *)(((((( uint32_t)0x40000000) + 0x60000) + 0x24)+(0x10*(1)))))=(0x00);
    }
}
...
void DrvUSB_Reset(uint32_t u32EpNum)
{
    ...
    if(u32EpId != (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVUSB) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((2) & 0x7F)))
    {
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId))))=(CFG_EP_SETTING[u32EpId]) & 0x03FF;
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10 * (u32EpId))))=(0x00000001) & 0x03;
    }
...
void DrvUSB_ClrCtrlReady(void)
{
    ...
    u32EpId = DrvUSB_GetEpIdentity(0, 0x00);
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))) | 0x00000001);
    u32EpId = DrvUSB_GetEpIdentity(0, 0x80);
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))) | 0x00000001);
}
...
void DrvUSB_ClrCtrlReadyAndTrigStall(void)
{
    ...
    u32EpId = DrvUSB_GetEpIdentity(0, 0x00);
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))) | (0x00000002 | 0x00000001));
    u32EpId = DrvUSB_GetEpIdentity(0, 0x80);
    *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))) | (0x00000002 | 0x00000001));
}
...
uint32_t DrvUSB_GetSetupBuffer(void)
{
    return (uint32_t)gsUsbDevice.sEpCrl[6].u8SramBuffer;
}
...
{   
    ...
    if (u32MaxPower > 0xFA)
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVUSB) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((4) & 0x7F));
    }
...
void DrvUSB_PreDispatchFDTEvent(S_DRVUSB_DEVICE *psDevice)
{
    ...
    if (u32FLDET & 1)
    {
        ...
        psDevice->u16MiscEventFlags |= 0x00000001;
    }
    else
    {
        ...
        psDevice->u16MiscEventFlags |= 0x00000002;
    }
}
...
void DrvUSB_PreDispatchBusEvent(S_DRVUSB_DEVICE *psDevice)
{
    ...
    if (u32Attr & 0x00000001)
    {
         
        *((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR)))=0x7D0;  
        psDevice->eUsbState = eDRVUSB_DEFAULT;
        psDevice->u16MiscEventFlags |= 0x00000004;
    }
    else if (u32Attr & 0x00000002)
    {
        ...
        *((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR)))=0x7C0;  
        ...
        psDevice->u16MiscEventFlags |= 0x00000008;

    }
    else if (u32Attr & 0x00000004)
    {
        ...
        *((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR)))=0x7D0;  
        ...
        psDevice->u16MiscEventFlags |= 0x00000010;
    }
}
...
void DrvUSB_PreDispatchEPEvent(S_DRVUSB_DEVICE *psDevice)
{
    ...
    u32INTSTS &= (0x00010000 | 0x00020000 | 0x00040000 | 0x00080000 | 0x00100000 | 0x00200000 | 0x80000000);

    if (u32INTSTS & 0x80000000)
    {
         
        psDevice->u16MiscEventFlags |= 0x00000020;
    ...
    u32INTSTS = (*((volatile unsigned int *)(&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS))); 
    *((volatile unsigned int *)(&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTSTS))=(u32INTSTS & 0x00FF0000UL);
    ...
    for (i=16;i<16+6;i++)
    {
        if (u32INTSTS & (1 << i))
        {
            ...
            u32EpNum = (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28) + (u32EpId) * 0x10))) & 0x03FF) & 0x0000000F);    
            
            u32PacketType = ((u32EPSTS >> (4 + u32EpId * 3)) & 0x70);
            
            if (u32PacketType == 0x00)
            {
                 
                psDevice->u16EPEventFlags |= (1 << (u32EpNum*2));
            }
            else if(u32PacketType == 0x20)
            {
            ...
            else if(u32PacketType == 0x70)
            {
                u32ISOPacketType = (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28) + (u32EpId) * 0x10))) & 0x03FF) & 0x00000060);
...
static void DrvUSB_UnInit(void)
{
    ...
    *((volatile unsigned int *)((&((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->ATTR)))=0x760;
    ...
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.USBD_EN = 0;
}
...
void DrvUSB_CtrlSetupSetAddress(void * pVoid)
{
    ...
    if (eUsbState == eDRVUSB_DEFAULT)
    {
        ...
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(0))))=0 ? (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(0)))))) & 0x37F) : (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(0)))))) | 0x80);
...
void DrvUSB_CtrlSetupClearSetFeature(void * pVoid)
{
    ...
    if ((pInfraDevice->au8Setup[0] == 0x00) && (pInfraDevice->au8Setup[2] == 0x01))
    {
        if(pInfraDevice->au8Setup[1] == 0x03)
            DrvUSB_EnableRemoteWakeup();
        if(pInfraDevice->au8Setup[1] == 0x01)
    ...
    else if ((pInfraDevice->au8Setup[0] == 0x02) && (pInfraDevice->au8Setup[2] == 0x00))
    {
        u32EpId = DrvUSB_GetEpId(pInfraDevice->au8Setup[4]);
        
        if (u32EpId < 6)
        {
            *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId))))=(*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(u32EpId))))) & ~0x00000080;
            if (pInfraDevice->au8Setup[1] == 0x01)
            {
                *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10 * (u32EpId))))=(*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10 * (u32EpId))))) & ~0x00000002;
            }
            else
            {
                *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))=(*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(u32EpId))))) | 0x00000002;
...
void DrvUSB_CtrlSetupGetStatus(void * pVoid)
{
    ...
    else if (pInfraDevice->au8Setup[0] == 0x82)
    {
        if (u32EpId < 6)
        {
            ...
            au8Buf[0] = (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10 * (u32EpId))))) & 0x03) & 0x00000002) ? 1 : 0;
        }
        else
        {
            DrvUSB_ClrCtrlReadyAndTrigStall();
...
void DrvUSB_CtrlDataInSetAddress(void * pVoid)
{
    ...
    {
        DrvUSB_SetUsbState(eDRVUSB_ADDRESS);
        (((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->FADDR . FADDR = pInfraDevice ->u8UsbAddress);
    }   
}
