...
#line 9 "Smpl_HID_IO.c"
#line 10 "Smpl_HID_IO.c"
#line 1 "Motor_Ctrl.h"
...
void Init_SYS() {
	InitMotor(&motorX,15000,20000);
	InitMotor(&motorY,15000,20000);
...
void DRVPWM_PwmIRQHandler_X() {
		if(mcX.step_remain>0 && mcX.enable == 1) {
			
				mcX.step_remain--;
				if(mcX.c_motor->direction == 1) {
...
void DRVPWM_PwmIRQHandler_Y() {
		if(mcY.step_remain>0 && mcY.enable == 1) {
			
				mcY.step_remain--;
				if(mcY.c_motor->direction == 1) {
