...
{
	*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(0))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(0))))) | (0x00000002 | 0x00000001));
	*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(1))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(1))))) | (0x00000002 | 0x00000001));
}

static void _HID_CLR_CTRL_READY()
{
	*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(0))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(0))))) | 0x00000001);
	*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(1))))=((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x2C)+(0x10*(1))))) | 0x00000001);
}
...
{
	{DrvUSB_CtrlDataInAck   , &g_HID_sDevice}, 
	{DrvUSB_CtrlDataOutAck  , &g_HID_sDevice}, 
...
{   
	{0x00, 0x05, DrvUSB_CtrlSetupSetAddress, DrvUSB_CtrlDataInSetAddress, 0, &g_HID_sDevice},
	{0x00, 0x01, DrvUSB_CtrlSetupClearSetFeature, 0, 0, &g_HID_sDevice},
	{0x00, 0x03, DrvUSB_CtrlSetupClearSetFeature, 0, 0, &g_HID_sDevice},
	{0x00, 0x08, DrvUSB_CtrlSetupGetConfiguration, 0, 0, &g_HID_sDevice},
	{0x00, 0x00, DrvUSB_CtrlSetupGetStatus, 0, 0, &g_HID_sDevice},
	{0x00, 0x0A, DrvUSB_CtrlSetupGetInterface, 0, 0, &g_HID_sDevice},
	{0x00, 0x0B, DrvUSB_CtrlSetupSetInterface, 0, 0, &g_HID_sDevice},
	{0x00, 0x06, HID_CtrlSetupGetDescriptor, HID_CtrlGetDescriptorIn, HID_CtrlGetDescriptorOut, &g_HID_sDevice},
	{0x00, 0x09, DrvUSB_CtrlSetupSetConfiguration, 0, 0, &g_HID_sDevice},
	 
	{0x20, 0x01, HID_CtrlSetupGetReport, 0, 0, &g_HID_sDevice},
	
	{0x20, 0x09, HID_CtrlSetupSetReport, 0, 0, &g_HID_sDevice},
	{0x20, 0x0A, HID_CtrlSetupSetIdle, 0, 0, &g_HID_sDevice},
	{0x20, 0x0B, HID_CtrlSetupSetProtocol, 0, 0, &g_HID_sDevice},
};

 
void (*pfHID_GetInReport)(uint8_t *buf) = 0;

 
void (*pfHID_SetOutReport)(uint8_t *buf) = 0;
...
int32_t HID_Open(uint32_t inReportSize, void *pfGetInReport, void *pfSetOutReport)
{
    ...
    if((uint32_t)pfGetInReport != 0)
        pfHID_GetInReport = (void(*)(uint8_t *))pfGetInReport;
        
    if((uint32_t)pfSetOutReport != 0)
	...
	g_HID_sDevice.pu8HIDDescriptor = g_HID_sDevice.au8ConfigDescriptor + 9 + 9;	
	g_HID_sDevice.pu8IntInEPDescriptor = g_HID_sDevice.au8ConfigDescriptor + 9 + 9 + 0x09;
...
void HID_Start(S_HID_DEVICE *psDevice)
{
	DrvUSB_DataIn(0x01, psDevice->pu8Report, psDevice->u32ReportSize);
   	DrvUSB_DataOutTrigger(0x02, 64);
}
...
void HID_IntOutCallback(void * pVoid)
{
    ...
    pu8EpBuf = DrvUSB_GetOutData(0x02, &u32Size);
...
int32_t HID_SetReportDescriptor(const uint8_t* pu8ReportDescriptor, uint32_t u32ReportDescriptorSize)
{
	if (pu8ReportDescriptor == 0)
	{
		return ((((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_HID) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F)));
	}
...
int32_t HID_SetReportBuf(uint8_t* pu8Report, uint32_t u32ReportSize)
{
	...
	if (u32ReportSize > 64)
	{
		return ((((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_HID) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((5) & 0x7F)));
	}
...
void HID_CtrlSetupSetReport(void * pVoid)
{
	...
	else if (psDevice->au8Setup[3] == 0x02)
	{
	...
	else if (psDevice->au8Setup[3] == 0x03)
	{
         

        DrvUSB_DataOutTrigger(0x00, 64);
...
void HID_CtrlSetupSetIdle(void * pVoid)
{
	...
	*((volatile unsigned int *)(((((( uint32_t)0x40000000) + 0x60000) + 0x24)+(0x10*(0)))))=(0x00);
...
void HID_CtrlGetDescriptorIn(void * pVoid)
{
    ...
    if(gpu8UsbBuf)
    {
        ...
        {
            u32Len = ((gu32BytesInUsbBuf)<(64) ? (gu32BytesInUsbBuf) : (64));
...
void HID_CtrlSetupGetDescriptor(void * pVoid)
{
	...
	case 0x01:
	{
        HID_PrepareDescriptors(g_HID_sDevice.au8DeviceDescriptor, 18, u16Len, 64);
	...
	case 0x02:
	{	
        HID_PrepareDescriptors(g_HID_sDevice.au8ConfigDescriptor, gau8ConfigDescriptor[2], u16Len, 64);
		break;
    }
		
	case 0x21:
    {
        HID_PrepareDescriptors(g_HID_sDevice.pu8HIDDescriptor, 0x09, u16Len, 64);
		break;
    }
		
	case 0x22:
	{
        HID_PrepareDescriptors(g_HID_sDevice.pu8ReportDescriptor, g_HID_sDevice.u32ReportDescriptorSize, u16Len, 64);
		break;
    }
	...
	case 0x03:
	{
		...
		{
            HID_PrepareDescriptors(gau8StringLang, 4, u16Len, 64);
		}
		else
		{
			...
			{
			case 1:
                HID_PrepareDescriptors((const uint8_t *)gau8VendorStringDescriptor, gau8VendorStringDescriptor[0], u16Len, 64);
				break;

			case 2:
                HID_PrepareDescriptors((const uint8_t *)gau8ProductStringDescriptor, gau8ProductStringDescriptor[0], u16Len, 64);
               
 				break;

			case 3:
                HID_PrepareDescriptors(gau8StringSerial, gau8StringSerial[0], u16Len, 64);
				break;
