...
const uint32_t g_HID_u32DeviceReportDescriptorSize = sizeof (g_HID_au8DeviceReportDescriptor) / sizeof(g_HID_au8DeviceReportDescriptor[0]);




static uint8_t g_au8DeviceReport[64];
...
const uint8_t gau8DeviceDescriptor[] =
{
	...
	0x0416+0x104 & 0x00FF,
	(0x0416+0x104 & 0xFF00) >> 8,
	
	0x501B+0x100 & 0x00FF,
	(0x501B+0x100 & 0xFF00) >> 8,
	0x00, 0x00,		
	0x01,			
	0x02,			
	0x03,			
...
const uint8_t gau8ConfigDescriptor[] =
{
	...
	sizeof (g_HID_au8DeviceReportDescriptor) / sizeof(g_HID_au8DeviceReportDescriptor[0]) & 0x00FF,
	(sizeof (g_HID_au8DeviceReportDescriptor) / sizeof(g_HID_au8DeviceReportDescriptor[0]) & 0xFF00) >> 8,
...
void HID_Init(void *pfGetInReport, void *pfSetOutReport)
{
    ...
    HID_Open(64, pfGetInReport, pfSetOutReport);
...
int32_t HID_MainProcess(void)
{
	...
	while(1)
	{
		...
		*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x00)))=(0) & (0x00000008 + 0x00000004 + 0x00000002 + 0x00000001);

		 
		((USBD_T *) ((( uint32_t)0x40000000) + 0x60000))->INTEN . FLDET_IE = 1;
		...
		*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x00)))=(0x00000008 | 0x00000100 | 0x00000004 | 0x00000002 | 0x00000001) & (0x00000008 + 0x00000004 + 0x00000002 + 0x00000001);
